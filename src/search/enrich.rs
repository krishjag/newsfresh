...
mod tests {
    ...
    fn test_enrich_empty_record() {
        let record = GkgRecord {
            ...
            v1_persons: vec![], v2_enhanced_persons: vec![],
            v1_organizations: vec![], v2_enhanced_organizations: vec![],
            v1_themes: vec![], v2_enhanced_themes: vec![],
            v1_locations: vec![], v2_enhanced_locations: vec![],
            tone: None,
            quotations: vec![],
            sharing_image: None,
            v1_counts: vec![], v21_counts: vec![], v21_enhanced_dates: vec![],
